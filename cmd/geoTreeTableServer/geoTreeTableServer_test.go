...
func TestMainExec(t *testing.T) {
	...
	tests := []testStruct{
		...
		},
		{
			...
			httpMethod:                   http.MethodGet,
			url:                          "/api/v1" + urlGeoTree + "?limit=1&offset=0&created_by=999999",
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
			body:                         "",
		},
		{
			...
			paramKeyValues:               make(map[string]string),
			httpMethod:                   http.MethodGet,
			url:                          "/api/v1" + urlGeoTree + "/count?created_by=999999",
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
			body:                         "",
		},
		{
			...
			paramKeyValues:               make(map[string]string),
			httpMethod:                   http.MethodGet,
			url:                          "/api/v1" + urlGeoTree + "/geojson?created_by=999999",
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
			body:                         "",
		},
		...
		},
		{
			...
			paramKeyValues:               make(map[string]string),
			httpMethod:                   http.MethodGet,
			url:                          "/api/v1/geoTree/11111111-4444-5555-6666-777777777777",
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
			body:                         "",
		},
		...
		},
		{
			...
			paramKeyValues:               make(map[string]string, 0),
			httpMethod:                   http.MethodPut,
			url:                          "/api/v1/geoTree/setGoelandThingId/11111111-4444-5555-6666-777777777777",
			useFormUrlencodedContentType: true,
			useJwtToken:                  true,
			body:                         exampleGeoTreeGoelandThingId,
		},
